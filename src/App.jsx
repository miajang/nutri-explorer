      ...
      <header style={{ background: "#fff", borderBottom: "1px solid #e8eeec", position: "sticky", top: 0, zIndex: 100, padding: "10px 20px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ flexShrink: 0, whiteSpace: "nowrap" }}>
            <span style={{ fontSize: "1.95rem", fontWeight: 900, letterSpacing: "-.03em", color: "#0d7a5f" }}>Nutrient</span>
            <span style={{ fontSize: "1.15rem", fontWeight: 500, color: "#888" }}>Explorer</span>
          </div>
